#ifndef _DSA_STATS__HPP_
#define _DSA_STATS__HPP_
...
//#define SEA_MEASURE_FN dsa::ScopedStats __stats__(__FUNCTION__)
//#define SEA_MEASURE_FN_LAST dsa::ScopedStats __stats_last__(__FUNCTION__, true)
